...
# также все значения строковых столбцов приводим к нижнему регистру и удаляем дубли
# не заполненные ячейки с числовыми значениями заполняем средним значением по
# столбцу
